      ...
      <v-card>
        ...
        <div>
            <b-tabs active-nav-item-class="font-weight-bold text-uppercase text-danger " content-class="mt-3">
                <b-tab title="Laporan Pengeluaran per Bulan" >
                    <v-container>
                            ...
                            <v-row>
                                <v-col class="col-md-4">
                                    <v-autocomplete
                                        ...
                                        dense
                                        rounded
                                        placeholder="tahun laporan pengeluaran"
                                        :rules="tanggalRules"
                                        solo
                                        clearable
                                    ></v-autocomplete>
                    ...
                    <div>
                        <div id="cetak1"  class="d-flex justify-content-center">
                            <v-card v-show="laporanPengeluaran1" class="p-3" max-width="850px" outlined>
                                <v-card-title>
                                    <v-row>
                                ...
                                <v-card-body>
                                    ...
                                    <v-row>
                                        <p class="text-center font-weight-bold" style="margin-top:-10px">LAPORAN PENGELUARAN BULANAN</p>    
                                    </v-row>
                                    ...
                                    <v-row style="margin-top:-10px">
                                        <t-head>
                                            <tr>
                                                ...
                                                <th width="200px" style="text-align:center;">Total Pengeluaran</th>
                                            </tr>
                                        </t-head>
                                    </v-row>
                        ...
                        <div class="d-flex justify-content-center">    
                            <v-btn
                                class="ma-2"
                                color="secondary" 
                                v-show="laporanPengeluaran"
                                @click="laporanPengeluaran1 = false" 
                                style="padding-left: 30px; padding-right: 30px;"
                            >Tutup</v-btn>
                            ...
                            <v-btn
                                ...
                                @click="cetakLaporan1"
                                style="padding-left: 30px; padding-right: 30px;"
                                v-show="laporanPengeluaran1"
                            >Cetak</v-btn>
                        </div>
                    </div>
                </b-tab>
                <b-tab title="Laporan Pengeluaran per Tahun" >
                    <v-container>
                    ...
                    <div>
                        <div id="cetak2"  class="d-flex justify-content-center">
                            <v-card v-show="laporanPengeluaran2" class="p-3" max-width="850px" outlined>
                                <v-card-title>
                                    <v-row>
                                        <v-col class="col-md-4 col-sm-12">
                                            <img src="../assets/akb.png" alt="Logo Atma BBQ">
                                ...
                                <v-card-body>
                                    ...
                                    <v-row>
                                        <p class="text-center font-weight-bold" style="margin-top:-10px">LAPORAN PENGELUARAN TAHUNAN</p>    
                                    </v-row>
                                    <v-row style="margin-top:-10px">
                        ...
                        <div class="d-flex justify-content-center">    
                            <v-btn
                                class="ma-2"
                                color="secondary" 
                                v-show="laporanPengeluaran2"
                                @click="laporanPengeluaran2 = false" 
                                style="padding-left: 30px; padding-right: 30px;"
                            >Tutup</v-btn>
  ...
  methods: {
    ...
    generateLaporan(){
        if(this.$refs.form1.validate()){
            this.laporanPengeluaran1 = false;
    ...
    getLaporan1(){
        this.load = true;
        var url = this.$api + "/laporan-pengeluaran-1/"+this.form1.tahun;
        this.$http
        .get(url
            ,{
            headers:{
    ...
    cetakLaporan1(){
        ...
        setTimeout(() => html2PDF(cetak,{
            ...
            output : "Laporan Pengeluaran bulanan tahun " + this.form1.tahun+".pdf"
        }), 1000);

    },
    getLaporan2(){
        this.load = true;
        var url = this.$api + "/laporan-pengeluaran-2/"+this.form2.tahun1+"/"+this.form2.tahun2;
        this.$http
        .get(url
            ,{
            headers:{
    ...
    generateLaporan2(){
        if(this.$refs.form2.validate()){
            if(this.form2.tahun2<this.form2.tahun1 || this.form2.tahun2==this.form2.tahun1){
                ...
                this.laporanPengeluaran2 = false;
                this.getTanggalHariIni();
                this.getDataKaryawan();
                this.getLaporan2();
            }
